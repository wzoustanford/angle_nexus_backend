...
# STRICT: YOUR RESPONSE MUST ALWAYS BE IN JSON FORMAT
# STRICT: EMBED WIDGETS IN DIFFERENT LOCATIONS IN THE TEXT AT THE END AND RIGHT PLACES
# STRICT: USE ONLY IDs FROM THE WIDGETS LIST BELOW
# Sample Response:
```json
{
  "message": "Apple, Microsoft, and Oracle each boast strong leadership teams that drive sustained growth, though their strategies differ. \n\n• Leadership – Apple's CEO Timothy D. Cook leads a seasoned team, while Microsoft's CEO Satya Nadella leverages robust cloud solutions. {EQUITY_WIDGET:MSFT:EQUITY} {EQUITY_WIDGET:APPL:EQUITY} Oracle, led by CEO Safra Ada Catz, capitalizes on its enterprise software legacy. \n\n• Growth Potential – Financials reveal impressive revenue and net income. Apple's integrated ecosystem drives stellar FY2024 revenue, whereas Microsoft's diverse revenue streams secure solid profitability. {EARN_WIDGET:ORCL:EQUITY}",
  "symbols": [
    "MSFT",
    "ORCL"
  ]
